...
export class ProjectSerializer {
  ...
  private static readObject(value: unknown, index: number): ObjectData {
    ...
    return {
      ...
      tankRole: str(value.tankRole, 'none'),
      fixtureFlowGpm: Math.max(0, num(value.fixtureFlowGpm, 0)),
      fixtureMinutesPerDay: Math.max(0, num(value.fixtureMinutesPerDay, 0)),
      drainsToGrey: bool(value.drainsToGrey, true),
